...
<p>
  ...
  <p>If you enable <b>Guard clicks</b> in the Color Filter while exactly one paintable template color is visible, Blue Marble blocks manual map clicks, left-drag placement gestures, and Space-drag placement gestures that do not match that visible template color. It does not place pixels, move clicks, or retry clicks automatically.</p>
